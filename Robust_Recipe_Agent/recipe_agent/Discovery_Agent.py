...
def create_recipe_discovery_agent() -> Agent:
    """Create and configure the recipe discovery agent with all tools and prompts."""
    ...
    # Main search tool
    agent.tool(search_and_process_recipes_tool)
