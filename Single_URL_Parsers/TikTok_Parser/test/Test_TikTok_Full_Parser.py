#!/usr/bin/env python3
"""
Test CLI for complete TikTok recipe parsing (Steps 1-10).

Tests full pipeline:
1-4: TikTok-specific extraction
...
def main():
    """
    Test the complete TikTok recipe parsing pipeline.
    """
    print("=" * 70)
    print("🎵 TikTok Recipe JSON Parser Test (Complete Pipeline)")
    print("=" * 70)
    ...
    try:
        ...
        print("\n🚀 Running TikTok recipe parsing pipeline...\n")

        # Parse TikTok recipe to JSON
        recipe_json = transcriber.parse_tiktok_recipe_to_json(tiktok_url)
