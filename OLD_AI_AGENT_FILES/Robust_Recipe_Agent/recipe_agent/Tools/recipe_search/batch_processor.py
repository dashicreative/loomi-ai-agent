...
from recipe_agent.Tools.recipe_search.pipeline.stage_1_web_search import search_recipes_serpapi, search_recipes_google_custom, search_recipes_parallel_priority
from recipe_agent.Tools.recipe_search.pipeline.stage_2_url_ranking import rerank_results_with_llm
from recipe_agent.Tools.recipe_search.pipeline.stage_3_url_classification import classify_urls_batch
from parsers.recipe_parser import parse_recipe
from recipe_agent.Tools.recipe_search.pipeline.stage_5_nutrition_normalization import normalize_nutrition_data
from recipe_agent.Tools.recipe_search.pipeline.stage_6_requirements_verification import verify_recipes_meet_requirements
from recipe_agent.Tools.recipe_search.pipeline.stage_7_relevance_ranking import rank_qualified_recipes_by_relevance
from recipe_agent.Tools.recipe_search.pipeline.stage_8_list_processing import expand_urls_with_lists, ListParser
# STAGE 8B IMPORTS (TEMPORARILY DISABLED - reverting to 9a/9b)
# from recipe_agent.Tools.recipe_search.pipeline.stage_8b_unified_formatting import (
#     format_recipes_unified_async, 
#     create_minimal_recipes_for_agent, 
#     create_failed_parse_report
# )
from recipe_agent.Tools.recipe_search.pipeline.stage_9c_final_formatting import (
    format_recipes_for_ios, 
    create_minimal_recipes_for_agent, 
    create_failed_parse_report
)
from recipe_agent.Tools.recipe_search.pipeline.stage_9b_ingredient_categorization import categorize_uncategorized_ingredients_parallel
from urllib.parse import urlparse
from recipe_agent.Tools.recipe_search.pipeline.utils.constants import PRIORITY_SITES, BLOCKED_SITES
...
from recipe_agent.Tools.Detailed_Recipe_Parsers.nutrition_parser import parse_nutrition_list

# Import modular components
from recipe_agent.Tools.recipe_search.stage_logger import PipelineStageLogger
...
async def search_and_process_recipes_tool(ctx: RunContext[RecipeDeps], query: str, needed_count: int = 5, requirements: Dict = None, exclude_urls: List[str] = None) -> Dict:
    ...
    try:
        from recipe_agent.Tools.recipe_search.pipeline.stage_9a_ingredient_parsing import process_all_recipe_ingredients
    ...
    # try:
    #     from recipe_agent.Tools.recipe_search.pipeline.stage_8b_unified_formatting import format_recipes_unified_async
