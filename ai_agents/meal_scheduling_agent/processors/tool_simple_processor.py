"""
Tool-Based Simple Processor - Handles straightforward single-meal requests using tools

This replaces the original simple_processor.py with a tool-based version.
"""
